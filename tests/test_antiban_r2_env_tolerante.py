...
LEITURAS_NO_IMPORT = [
    ...
    # rodada 2, item 7: a suspensão global do YouTube
    ("ATHENA_YOUTUBE_SUSPENSAO_S", "_YOUTUBE_SUSPENSAO_S", "10800.0"),
    ("ATHENA_YOUTUBE_SUSPENSAO_TETO_S", "_YOUTUBE_SUSPENSAO_TETO_S", "86400.0"),
    ("ATHENA_YOUTUBE_DEGRAU_ZERA_S", "_YOUTUBE_DEGRAU_ZERA_S", "172800.0"),
    # D3, item 4: o aviso da suspensão vencida sem prova
    ("ATHENA_YOUTUBE_ALERTA_VENCIDA_S", "_YOUTUBE_ALERTA_VENCIDA_S", "21600.0"),
]
